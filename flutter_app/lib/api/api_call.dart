...
class APICallService {
  ...
  Future<Map<String, dynamic>> makeAPICall(
    ...
    var uri = Uri.parse(
        'https://api.openweathermap.org/data/2.5/onecall?lat=${locationData?.latitude}&lon=${locationData?.longitude}&exclude=minutely,alerts&appid=${api_key_weather}&units=metric&lang=kr');
